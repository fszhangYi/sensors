...
def load_all_drivers() -> None:
    ...
    from sensors.drivers.arm import elite_write as _arm_write  # noqa: F401
    ...
    from sensors.drivers.extensions import force_torque as _ft  # noqa: F401
    from sensors.drivers.extensions import paxini as _tac  # noqa: F401
